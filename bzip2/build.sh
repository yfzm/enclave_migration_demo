...
x86_objs="
    ...
    ${APP}_x86_64.o
    ${lib_build_path}/x86_64/blocksort.o
    ${lib_build_path}/x86_64/bzip2.o
    ${lib_build_path}/x86_64/bzlib.o
    ${lib_build_path}/x86_64/compress.o
    ${lib_build_path}/x86_64/crctable.o
    ${lib_build_path}/x86_64/decompress.o
    ${lib_build_path}/x86_64/huffman.o
    ${lib_build_path}/x86_64/randtable.o
...
arm_objs="
    ...
    ${APP}_aarch64.o
    ${lib_build_path}/aarch64/blocksort.o
    ${lib_build_path}/aarch64/bzip2.o
    ${lib_build_path}/aarch64/bzlib.o
    ${lib_build_path}/aarch64/compress.o
    ${lib_build_path}/aarch64/crctable.o
    ${lib_build_path}/aarch64/decompress.o
    ${lib_build_path}/aarch64/huffman.o
    ${lib_build_path}/aarch64/randtable.o
