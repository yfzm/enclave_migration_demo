...
#define SAVE_PARALLEL_ARCHIVE 31
...
} __attribute__((aligned(16))) gauge_header;
...
/* Note that an effort is made to make all doubleing point and integer
...
/* lattice constants c1, c2 (2 32 bit doubleing number ) */
...
/* For compatibility */
gauge_file *save_old_binary(char *filename, double c1, double c2);
